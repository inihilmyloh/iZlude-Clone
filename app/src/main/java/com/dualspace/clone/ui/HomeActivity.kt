...
class HomeActivity : AppCompatActivity() {
    ...
    private val cloneReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            when (intent?.action) {
                "com.dualspace.clone.CLONE_COMPLETE" -> {
                    updateStats()
                    Toast.makeText(
                        this@HomeActivity,
                ...
                "com.dualspace.clone.CLONE_REMOVED" -> {
                    updateStats()
                }
            }
        }
    ...
    private fun registerCloneReceiver() {
        val filter = IntentFilter().apply {
            addAction("com.dualspace.clone.CLONE_COMPLETE")
            addAction("com.dualspace.clone.CLONE_REMOVED")
        }
